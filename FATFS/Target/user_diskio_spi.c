...
/* Set SCLK = slow. On STM32F030R8 at 48MHz, this is 375 KBits/s (JV)*/
...
/* Set SCLK = fast. On STM32F030R8 at 48MHz, this is 12 MBits/s (JV)*/
...
)
{
	...
	FCLK_FAST();            /* Set fast clock -- used by other devices (JV) */
	if (ty) {			/* OK */
